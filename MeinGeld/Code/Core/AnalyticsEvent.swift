...
extension AnalyticsEvent {
  ...
  static let passwordResetRequested = AnalyticsEvent(
    name: "password_reset_requested"
  )
  static let passwordResetCompleted = AnalyticsEvent(
    name: "password_reset_completed"
  )
  static let accountDeleted = AnalyticsEvent(name: "account_deleted")
  static let emailVerificationSent = AnalyticsEvent(
    name: "email_verification_sent"
  )
  static let emailVerified = AnalyticsEvent(name: "email_verified")

  // Transaction Events
  static func transactionCreated(type: String, category: String, amount: Double)
    -> AnalyticsEvent
  {
  ...
  static func transactionDeleted(type: String, category: String)
    -> AnalyticsEvent
  {
    return AnalyticsEvent(
  ...
  // Error Events
  static func errorOccurred(errorType: String, context: String)
    -> AnalyticsEvent
  {
    return AnalyticsEvent(
      name: "error_occurred",
