...
protocol DataServiceProtocol {
    ...
    func fetchTransactions(for user: User, limit: Int?, offset: Int?) async throws -> [Transaction]
    func fetchTransactions(for account: Account, limit: Int?, offset: Int?) async throws -> [Transaction]
